...
def getFrequencyDict(sequence):
    ...
    for x in sequence:
        ...
        #get the frequency of x, if in dictionary, otherwise 0
    return freq
...
def getWordScore(word, n):
    ...
    if len(word)==n:
        bonus=50
    total_score=word_score*len(word)+bonus
    return total_score
...
def isValidWord(word, hand, wordList):
    ...
    if word in wordList and in_hand==True:
        ans=True
    ...
    while calculateHandlen(hand)>0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                print('"' + str(word) + '"'+ ' earned ' + str(str(getWordScore(word, n)) +' points' ) +' points. Total: ' + str(total_score) +' points\n' )
                # Update the hand 
